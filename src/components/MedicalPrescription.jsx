      ...
      <div style={fullScreenStyle}>
        <div style={contentStyle}>
          <div className="bg-white rounded shadow-lg p-4 mb-4">
            <h1 className="display-5 fw-bold text-primary mb-3">Medical Prescriptions</h1>
            <p className="text-secondary fs-5">This section will display your medical prescriptions.</p>
          </div>
        </div>
      </div>
    </>
